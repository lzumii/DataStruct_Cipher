...
public class Polybius implements ActionListener {
    ...
    public static ButtonCustom En, De;
    ...
    JFrame f;
    JLabel background, label, EnLabel, DeLabel;
    ...
    Polybius() {
       ...
       ImageIcon bgImg = new ImageIcon("bg.jpg");
        ...
        f.setLayout(null);
        f.setVisible(true);
        // add two JText panels pa for encipher and decipher
    }
