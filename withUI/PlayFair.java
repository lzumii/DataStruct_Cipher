...
// DECLARATIONS
    ...
    JLabel label; // FOR LABEL ON TOP
    ButtonCustom encipher, decipher; // FOR ENCIPHER AND DECIPHER BUTTONS
    ...
    PlayFair() {
        ...
        ImageIcon img = new ImageIcon("bg.jpg"); //BG IMPORT
        ...
        //BUTTONS ---> ENCIPHER
        encipher = new ButtonCustom("ENCIPHER");
        ...
        frame.add(btnp2);
        frame.add(bg);
        frame.getRootPane().setBorder(BorderFactory.createLineBorder(new Color(70, 50,170), 2));
