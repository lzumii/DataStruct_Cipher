...
public class main implements ActionListener {
    ...
    public static ImageIcon logoExit = new ImageIcon("res/logo/EXIT-HOVER.png");
    public static ImageIcon logoExitHover = new ImageIcon("res/logo/EXIT-RED.png");
    public static ImageIcon bgImg = new ImageIcon("res/background/bg.jpg");
    public static ImageIcon logo = new ImageIcon("res/logo/LOGO.png");

    // CALLING ALL JAVA FILE
    public Caesar caesar = new Caesar();
    public PlayFair playFair = new PlayFair();
    public Polybius polybius = new Polybius();
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == CC) {
            caesar.frame.setVisible(true);
            playFair.frame.setVisible(false);
            polybius.f.setVisible(false);

            caesar.Etext.setText("");
            caesar.Detext.setText("");
            caesar.s.setText("3");
        }
        else if (e.getSource() == PF) {
            caesar.frame.setVisible(false);
            playFair.frame.setVisible(true);
            polybius.f.setVisible(false);

            playFair.entxt.setText("");
            playFair.detxt.setText("");
            playFair.keytxt.setText("Keyword");
            playFair.group.setSelected(playFair.rb1.getModel(), true);
        }
        else if (e.getSource() == PS) {
            caesar.frame.setVisible(false);
            playFair.frame.setVisible(false);
            polybius.f.setVisible(true);

            polybius.Encipher.setText("");
            polybius.Decipher.setText("");
        }
    }
